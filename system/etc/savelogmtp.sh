...
############################################################################################
	...
	mv /data/media/0/diag_logs/list_diag_log_.txt /data/media/0/diag_logs/QXDM_logs
	echo "mv /data/media/0/diag_logs/list_diag_log_.txt /data/media/0/diag_logs/QXDM_logs"
